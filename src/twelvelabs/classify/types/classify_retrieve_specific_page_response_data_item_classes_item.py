...
class ClassifyRetrieveSpecificPageResponseDataItemClassesItem(UniversalBaseModel):
    ...
    clips: typing.Optional[
        typing.List[ClassifyRetrieveSpecificPageResponseDataItemClassesItemClipsItem]
